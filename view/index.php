...
<a href="../controller/index.php#debut" class="phone-only">
...
<div class=containerIndex id="debut">
    ...
    <div class= troisServices>
        <a class="box1 lumiere" href="../controller/service.php#carrosserie">
        ...
        <a class="box1 lumiere"  href="../controller/service.php#moteur">
        ...
        <a class="box1 lumiere" href="../controller/service.php#entretien">
            ...
            <div class=temoignage>
                <div class=enTete>
                    <div>
                        ...
                        <?php 
                        $nbStar = $TroisCommentaires[$i]["etoile"];
                        for ($j = 0; $j<$nbStar; $j++ ){ ?>
                ...
                <div>
                    <p><?php echo $TroisCommentaires[$i]["commentaire"]; ?> </p>
                </div>
