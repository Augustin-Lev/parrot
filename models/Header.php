...
<html lang="fr">
    <head>
        ...
        <?php if($header["javascript"] == "1") ?>
            <link rel="stylesheet" href="<?php echo BASE_URL;?>\views/style\jquery-ui.theme.css">
            <link rel="stylesheet" href="<?php echo BASE_URL;?>\views/style\jquery-ui.structure.css"> 
        <?php  ?>
